...
culturalUI <- function() {
  page_fluid(
    ...
    layout_columns(
      ...
      card(
        card_header(
          ...
          h1("Participación Cultural", class = "dashboard-header")
        )
      )
    ),
    
    # Info boxes section (unchanged structure)
    layout_columns(
      col_widths = c(4, 4, 4),
      ...
      value_box_with_title_tooltip(
        ...
        theme = value_box_theme(bg = "#d7a4d2", fg = "white"),
      ...
      value_box_with_title_tooltip(
        ...
        theme = value_box_theme(bg = "#eccfe9", fg = "white"),
    ...
    div(
      ...
      # Entertainment Activities Plot Card
      div(
        class = "plot-card plot-card-bienestar",
